...
// // Hook-style API (uses useMemo for caching like original)
...
//         // Select process with shortest burst time (SJF is non-preemptive)
...
//     const result = { fcfs, sjf, srtf, rr }[algorithm]?.();
